...
def load_vector_store(folder_path, embeddings, index_name='cpm-index'):
    ...
    folder_path = 'C:/Users/vsharma.A123SYSTEMSEU/Downloads/AgentEIS-main/vector_path/'
...
class Application(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.api_entry.insert(0, "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")
    ...
    def create_vector_store(self):
        api_key = self.api_entry.get().strip() or "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"
    ...
    def run_search(self):
        default_api_key = "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"
